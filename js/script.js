document.addEventListener('DOMContentLoaded', () => {
  ...
  const systems = [
    ...
    },
    {
      ...
      domain: 'Subsidiary Company · Heuronics',
      partner: 'HEURONICS',
      metric: '',
      icon: '◌',
    ...
    },
    {
      ...
      domain: 'Subsidiary company · CHEM Defense',
    ...
    },
    {
      ...
      domain: 'Subsidiary comapny · Tarkx Defense',
      partner: 'TARKX DEFENSE',
      metric: '',
      icon: '➤',
